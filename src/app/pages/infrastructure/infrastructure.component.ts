...
export class InfrastructureComponent {
  ...
  generateDefenseUpgrades(): InfrastructureUpgrade[] {
    return [
      { id: 'defense_railguns', title: 'Orbitale Railguns', imagePath: 'assets/img/orbitale-railguns.png', requiredLevel: 5, baseCost: { credits: 1500, eisen: 1000, energie: 300 }, costMultiplier: 1.5, description: 'Verschießt massive Projektile mit extremer Geschwindigkeit.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Verteidigungsstärke` },
      { id: 'defense_plasmakanonen', title: 'Plasmakanonen', imagePath: 'assets/img/plasmakanonen.png', requiredLevel: 12, baseCost: { credits: 4000, silber: 1500, energie: 800 }, costMultiplier: 1.6, description: 'Hochenergetische Plasmawaffen zur Abwehr schwerer Schiffe.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Verteidigungsstärke` },
      { id: 'defense_schildgeneratoren', title: 'Schildgeneratoren', imagePath: 'assets/img/schildgeneratoren.png', requiredLevel: 20, baseCost: { credits: 12000, gold: 3000, energie: 2000 }, costMultiplier: 1.8, description: 'Ein planetenweiter Energieschild fängt feindliches Feuer ab.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Verteidigungsstärke` },
      { id: 'defense_tachyonen_lanzen', title: 'Tachyonen-Lanzen', imagePath: 'assets/img/tachyonen-lanzen.png', requiredLevel: 25, baseCost: { credits: 35000, xenonit: 3000, energie: 5000 }, costMultiplier: 2.0, description: 'Durchschlägt selbst stärkste Schilde mit Leichtigkeit.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Verteidigungsstärke` },
    ];
  }
  ...
  generateStationUpgrades(): InfrastructureUpgrade[] {
    return [
      { id: 'station_verstaerkte_huelle', title: 'Verstärkte Hülle', imagePath: 'assets/img/verstaerkte-huelle.png', requiredLevel: 12, baseCost: { credits: 2000, eisen: 1500, energie: 500 }, costMultiplier: 1.5, description: 'Verstärkte Panzerung schützt die Station vor Meteoriteneinschlägen.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Stationseffizienz` },
      { id: 'station_hydroponische_gaerten', title: 'Hydroponische Gärten', imagePath: 'assets/img/hydroponische-gaerten.png', requiredLevel: 18, baseCost: { credits: 5000, nahrung: 2000, energie: 1000 }, costMultiplier: 1.6, description: 'Selbstversorgende Gärten für die Besatzung.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Stationseffizienz` },
      { id: 'station_kommerz_hub', title: 'Kommerz-Hub', imagePath: 'assets/img/kommerz-hub.png', requiredLevel: 25, baseCost: { credits: 15000, gold: 5000, energie: 2500 }, costMultiplier: 1.8, description: 'Ein Handelszentrum zieht Händler aus der ganzen Galaxie an.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Stationseffizienz` },
      { id: 'station_orbitaler_verteidigungsring', title: 'Orbitaler Verteidigungsring', imagePath: 'assets/img/orbitaler-verteidigungsring.png', requiredLevel: 30, baseCost: { credits: 50000, xenonit: 5000, energie: 10000 }, costMultiplier: 2.0, description: 'Ein Ring aus Waffenplattformen verteidigt die Station.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Stationseffizienz` },
    ];
  }
