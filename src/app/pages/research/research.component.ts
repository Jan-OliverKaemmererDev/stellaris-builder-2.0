...
/**
 * Research page displaying the technology skill tree.
 * Includes Bio-Lab, AI Automation, and Propulsion Technology upgrades.
 */
@Component({
...
export class ResearchComponent {
  /** Research technology nodes ordered by unlock progression. */
  nodes: SkillNode[] = [
    {
      id: 'biolabor',
