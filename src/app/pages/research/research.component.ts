  ...
  items: ResearchItem[] = [
    {
      ...
      upgrades: [
        { id: 'bio_gen_sequenzierer', title: 'Gen-Sequenzierer', imagePath: 'assets/img/bio-forschungslabor.png', requiredLevel: 5, baseCost: { credits: 200, nahrung: 150 }, costMultiplier: 1.4, description: 'Analysiert und optimiert genetische Codes für bessere Erträge.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Forschungseffizienz` },
        { id: 'bio_hydroponik', title: 'Hydroponik-Experimente', imagePath: 'assets/img/bio-forschungslabor.png', requiredLevel: 10, baseCost: { credits: 800, nahrung: 500 }, costMultiplier: 1.5, description: 'Wasserkulturen für erdelosen Pflanzenanbau im All.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Forschungseffizienz` },
        { id: 'bio_zell_regeneration', title: 'Zelluläre Regeneration', imagePath: 'assets/img/bio-forschungslabor.png', requiredLevel: 15, baseCost: { credits: 3000, nahrung: 2000, energie: 500 }, costMultiplier: 1.7, description: 'Regeneriert beschädigtes Gewebe auf zellulärer Ebene.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Forschungseffizienz` },
        { id: 'bio_klon_vat', title: 'Klon-Vat-Technologie', imagePath: 'assets/img/bio-forschungslabor.png', requiredLevel: 20, baseCost: { credits: 15000, nahrung: 8000, xenonit: 500 }, costMultiplier: 1.9, description: 'Klont Arbeitskräfte für maximale Produktivität.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Forschungseffizienz` },
      ],
    },
    {
      ...
      upgrades: [
        { id: 'ki_neuronale_netze', title: 'Neuronale Netze', imagePath: 'assets/img/ki-automatisierung.png', requiredLevel: 8, baseCost: { credits: 1000, silber: 300, energie: 500 }, costMultiplier: 1.5, description: 'Tiefe neuronale Netze für komplexe Musterkennung.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% KI-Effizienz` },
        { id: 'ki_quanten_prozessoren', title: 'Quanten-Prozessoren', imagePath: 'assets/img/ki-automatisierung.png', requiredLevel: 12, baseCost: { credits: 4000, gold: 500, energie: 1500 }, costMultiplier: 1.6, description: 'Quantencomputer ermöglichen exponentiell schnellere Berechnungen.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% KI-Effizienz` },
        { id: 'ki_selbstlernend', title: 'Selbstlernende Algorithmen', imagePath: 'assets/img/ki-automatisierung.png', requiredLevel: 18, baseCost: { credits: 12000, gold: 2000, energie: 4000 }, costMultiplier: 1.8, description: 'KI verbessert sich kontinuierlich selbst.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% KI-Effizienz` },
        { id: 'ki_bewusstsein', title: 'Bewusstseins-Emulation', imagePath: 'assets/img/ki-automatisierung.png', requiredLevel: 25, baseCost: { credits: 50000, xenonit: 1000, energie: 15000 }, costMultiplier: 2.0, description: 'Eine wahrhaft bewusste KI leitet alle Operationen.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% KI-Effizienz` },
      ],
    },
    {
      id: 'nano_bots',
      ...
      upgrades: [
        { id: 'nano_krabbler', title: 'Nano-Krabbler', imagePath: 'assets/img/ki-automatisierung.png', requiredLevel: 10, baseCost: { credits: 1500, eisen: 500, energie: 600 }, costMultiplier: 1.5, description: 'Krabbler beschleunigen das Recycling und sparen Ressourcen.', effectFn: (lvl) => `Verbessert Nano-Bots Effizienz` },
        { id: 'nano_schweisser', title: 'Laser-Schweißer', imagePath: 'assets/img/ki-automatisierung.png', requiredLevel: 15, baseCost: { credits: 5000, silber: 1000, energie: 2000 }, costMultiplier: 1.6, description: 'Präzisions-Laser reduzieren Materialverschnitt.', effectFn: (lvl) => `Verbessert Nano-Bots Effizienz` },
        { id: 'nano_reparatur', title: 'Autonome Reparatur', imagePath: 'assets/img/ki-automatisierung.png', requiredLevel: 20, baseCost: { credits: 15000, gold: 2000, energie: 5000 }, costMultiplier: 1.8, description: 'Ermöglicht automatische Strukturinstandsetzung.', effectFn: (lvl) => `Verbessert Nano-Bots Effizienz` },
        { id: 'nano_replikator', title: 'Nano-Replikator', imagePath: 'assets/img/ki-automatisierung.png', requiredLevel: 25, baseCost: { credits: 60000, xenonit: 2000, energie: 20000 }, costMultiplier: 2.0, description: 'Erlaubt den Bots sich bei Bedarf selbst zu reproduzieren.', effectFn: (lvl) => `Verbessert Nano-Bots Effizienz` },
      ],
    },
    {
      id: 'antriebstechnik',
