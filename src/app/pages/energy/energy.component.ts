...
export class EnergyComponent {
  ...
  items: EnergyItem[] = [
    ...
    },
    {
      ...
      upgrades: [
        { id: 'fusion_plasma_eindaemmung', title: 'Plasma-Eindämmung', imagePath: 'assets/img/fusionsreaktoren.png', requiredLevel: 8, baseCost: { credits: 500, eisen: 300, energie: 100 }, costMultiplier: 1.5, description: 'Magnetfelder halten das Fusionsplasma stabil.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Fusionsleistung` },
        { id: 'fusion_deuterium_anreicherung', title: 'Deuterium-Anreicherung', imagePath: 'assets/img/fusionsreaktoren.png', requiredLevel: 12, baseCost: { credits: 1500, silber: 500, energie: 200 }, costMultiplier: 1.6, description: 'Effizientere Aufbereitung des Fusionsbrennstoffs.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Fusionsleistung` },
        { id: 'fusion_laser_katalysator', title: 'Laser-Katalysator', imagePath: 'assets/img/fusionsreaktoren.png', requiredLevel: 18, baseCost: { credits: 5000, gold: 1000, energie: 500 }, costMultiplier: 1.7, description: 'Laser zünden die Fusionsreaktion präziser und schneller.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Fusionsleistung` },
        { id: 'fusion_kaltfusions_matrix', title: 'Kaltfusions-Matrix', imagePath: 'assets/img/fusionsreaktoren.png', requiredLevel: 25, baseCost: { credits: 20000, xenonit: 800, energie: 1500 }, costMultiplier: 1.9, description: 'Revolutionäre Fusion bei niedrigen Temperaturen.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Fusionsleistung` },
      ],
    },
    {
      id: 'antimaterie',
      ...
      upgrades: [
        { id: 'antimaterie_positronen', title: 'Positronen-Sammler', imagePath: 'assets/img/fusionsreaktoren.png', requiredLevel: 10, baseCost: { credits: 3000, eisen: 1000, energie: 500 }, costMultiplier: 1.6, description: 'Sammelt Positronen aus kosmischer Strahlung.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Antimaterieertrag` },
        { id: 'antimaterie_magnetfelder', title: 'Magnetfelder', imagePath: 'assets/img/fusionsreaktoren.png', requiredLevel: 15, baseCost: { credits: 8000, silber: 2000, energie: 1000 }, costMultiplier: 1.8, description: 'Starke Magnetfelder für sichere Antimaterie-Eindämmung.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Antimaterieertrag` },
        { id: 'antimaterie_subraumkuehlung', title: 'Subraum-Kühlung', imagePath: 'assets/img/fusionsreaktoren.png', requiredLevel: 22, baseCost: { credits: 25000, gold: 5000, energie: 3000 }, costMultiplier: 2.0, description: 'Kühlt den Reaktorkern durch Subraum-Technologie.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Antimaterieertrag` },
        { id: 'antimaterie_nullpunkt', title: 'Nullpunkt-Siphon', imagePath: 'assets/img/fusionsreaktoren.png', requiredLevel: 30, baseCost: { credits: 100000, xenonit: 5000, energie: 10000 }, costMultiplier: 2.2, description: 'Zapft Energie direkt aus dem Quantenvakuum.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Antimaterieertrag` },
      ],
    },
  ];
