  ...
  items: TradeItem[] = [
    {
      ...
      effectFn: (lvl) => lvl === 0 ? 'Noch nicht gebaut.' : `Produziert ${calcExponential(100, lvl)} Credits/h`,
      upgrades: [
        { id: 'trade_lokale_gilden', title: 'Lokale Händlergilden', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 5, baseCost: { credits: 100, nahrung: 50 }, costMultiplier: 1.3, description: 'Organisierte Gilden verbessern die Handelseffizienz.', effectFn: (lvl) => `+${lvl * 5}% Handelseffizienz` },
        { id: 'trade_frachtdrohnen', title: 'Frachtdrohnen', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 15, baseCost: { credits: 400, eisen: 200 }, costMultiplier: 1.4, description: 'Autonome Drohnen liefern Waren schneller aus.', effectFn: (lvl) => `+${lvl * 5}% Handelseffizienz` },
        { id: 'trade_schwarzmarkt', title: 'Schwarzmarkt-Zugang', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 30, baseCost: { credits: 1500, gold: 500 }, costMultiplier: 1.5, description: 'Zugang zu illegalen, aber lukrativen Handelsrouten.', effectFn: (lvl) => `+${lvl * 5}% Handelseffizienz` },
        { id: 'trade_planetarer_zoll', title: 'Planetarer Zoll', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 50, baseCost: { credits: 5000, energie: 1000 }, costMultiplier: 1.7, description: 'Kontrollierter Zoll sichert Einnahmen bei jedem Handel.', effectFn: (lvl) => `+${lvl * 5}% Handelseffizienz` },
      ],
    },
    {
      ...
      effectFn: (lvl) => lvl === 0 ? 'Noch nicht gebaut.' : `Produziert ${calcExponential(400, lvl)} Credits/h`,
      upgrades: [
        { id: 'market_kartographierung', title: 'Routen-Kartographierung', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 5, baseCost: { credits: 1000, energie: 500 }, costMultiplier: 1.4, description: 'Kartographierte Routen verkürzen Lieferzeiten.', effectFn: (lvl) => `+${lvl * 5}% Markt-Effizienz` },
        { id: 'market_subraum_komm', title: 'Subraum-Kommunikation', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 15, baseCost: { credits: 3000, silber: 1000 }, costMultiplier: 1.5, description: 'Sofortige Kommunikation über Lichtjahre hinweg.', effectFn: (lvl) => `+${lvl * 5}% Markt-Effizienz` },
        { id: 'market_geleitschutz', title: 'Söldner-Geleitschutz', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 30, baseCost: { credits: 10000, eisen: 5000 }, costMultiplier: 1.6, description: 'Bewaffneter Schutz für Handelskonvois.', effectFn: (lvl) => `+${lvl * 5}% Markt-Effizienz` },
        { id: 'market_banken', title: 'Interstellare Banken', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 50, baseCost: { credits: 40000, gold: 8000 }, costMultiplier: 1.8, description: 'Banken ermöglichen galaktische Kredite und Investitionen.', effectFn: (lvl) => `+${lvl * 5}% Markt-Effizienz` },
      ],
    },
    {
      ...
      effectFn: (lvl) => lvl === 0 ? 'Noch nicht gebaut.' : `Produziert ${calcExponential(1500, lvl)} Credits/h`,
      upgrades: [
        { id: 'exchange_hft', title: 'Hochfrequenz-Trading', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 5, baseCost: { credits: 5000, energie: 2000 }, costMultiplier: 1.5, description: 'Algorithmen handeln in Nanosekunden.', effectFn: (lvl) => `+${lvl * 5}% Börsen-Effizienz` },
        { id: 'exchange_megakonzern', title: 'Megakonzern-Partnerschaften', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 15, baseCost: { credits: 20000, gold: 5000 }, costMultiplier: 1.6, description: 'Exklusive Partnerschaften mit galaktischen Megakonzernen.', effectFn: (lvl) => `+${lvl * 5}% Börsen-Effizienz` },
        { id: 'exchange_monopol', title: 'Monopol-Lizenzen', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 30, baseCost: { credits: 80000, xenonit: 3000 }, costMultiplier: 1.8, description: 'Exklusive Handelsrechte für bestimmte Sektoren.', effectFn: (lvl) => `+${lvl * 5}% Börsen-Effizienz` },
        { id: 'exchange_waehrungsamt', title: 'Galaktisches Währungsamt', imagePath: 'assets/img/infrastructure/trading-post.png', requiredLevel: 50, baseCost: { credits: 250000, xenonit: 10000 }, costMultiplier: 2.0, description: 'Kontrolliere die galaktische Währung.', effectFn: (lvl) => `+${lvl * 5}% Börsen-Effizienz` },
      ],
    },
  ];
