...
export class TradeComponent {
  ...
  items: TradeItem[] = [
    ...
    },
    {
      ...
      upgrades: [
        { id: 'market_kartographierung', title: 'Routen-Kartographierung', imagePath: 'assets/img/trading-post.png', requiredLevel: 8, baseCost: { credits: 1000, energie: 500 }, costMultiplier: 1.4, description: 'Kartographierte Routen verkürzen Lieferzeiten.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Markt-Effizienz` },
        { id: 'market_subraum_komm', title: 'Subraum-Kommunikation', imagePath: 'assets/img/trading-post.png', requiredLevel: 12, baseCost: { credits: 3000, silber: 1000 }, costMultiplier: 1.5, description: 'Sofortige Kommunikation über Lichtjahre hinweg.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Markt-Effizienz` },
        { id: 'market_geleitschutz', title: 'Söldner-Geleitschutz', imagePath: 'assets/img/trading-post.png', requiredLevel: 18, baseCost: { credits: 10000, eisen: 5000 }, costMultiplier: 1.6, description: 'Bewaffneter Schutz für Handelskonvois.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Markt-Effizienz` },
        { id: 'market_banken', title: 'Interstellare Banken', imagePath: 'assets/img/trading-post.png', requiredLevel: 25, baseCost: { credits: 40000, gold: 8000 }, costMultiplier: 1.8, description: 'Banken ermöglichen galaktische Kredite und Investitionen.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Markt-Effizienz` },
      ],
    },
    {
      ...
      upgrades: [
        { id: 'exchange_hft', title: 'Hochfrequenz-Trading', imagePath: 'assets/img/trading-post.png', requiredLevel: 10, baseCost: { credits: 5000, energie: 2000 }, costMultiplier: 1.5, description: 'Algorithmen handeln in Nanosekunden.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Börsen-Effizienz` },
        { id: 'exchange_megakonzern', title: 'Megakonzern-Partnerschaften', imagePath: 'assets/img/trading-post.png', requiredLevel: 15, baseCost: { credits: 20000, gold: 5000 }, costMultiplier: 1.6, description: 'Exklusive Partnerschaften mit galaktischen Megakonzernen.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Börsen-Effizienz` },
        { id: 'exchange_monopol', title: 'Monopol-Lizenzen', imagePath: 'assets/img/trading-post.png', requiredLevel: 22, baseCost: { credits: 80000, xenonit: 3000 }, costMultiplier: 1.8, description: 'Exklusive Handelsrechte für bestimmte Sektoren.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Börsen-Effizienz` },
        { id: 'exchange_waehrungsamt', title: 'Galaktisches Währungsamt', imagePath: 'assets/img/trading-post.png', requiredLevel: 30, baseCost: { credits: 250000, xenonit: 10000 }, costMultiplier: 2.0, description: 'Kontrolliere die galaktische Währung.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Börsen-Effizienz` },
      ],
    },
  ];
