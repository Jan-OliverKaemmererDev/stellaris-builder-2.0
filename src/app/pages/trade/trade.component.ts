  ...
  items: TradeItem[] = [
    {
      ...
      upgrades: [
        ...
        { id: 'trade_schwarzmarkt', title: 'Schwarzmarkt-Zugang', imagePath: 'assets/img/trade/schwarzmarkt-zugang.png', requiredLevel: 15, baseCost: { credits: 1500, gold: 500 }, costMultiplier: 1.4, description: 'Zugang zu illegalen, aber lukrativen Handelsrouten.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Handelseffizienz` },
        { id: 'trade_planetarer_zoll', title: 'Planetarer Zoll', imagePath: 'assets/img/trade/planetarer-zoll.png', requiredLevel: 20, baseCost: { credits: 5000, silber: 1000 }, costMultiplier: 1.5, description: 'Kontrollierter Zoll sichert Einnahmen bei jedem Handel.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Handelseffizienz` },
      ],
    },
    {
      ...
      upgrades: [
        ...
        { id: 'market_geleitschutz', title: 'Söldner-Geleitschutz', imagePath: 'assets/img/trade/soeldner-geleitschutz.png', requiredLevel: 15, baseCost: { credits: 10000, eisen: 5000 }, costMultiplier: 1.45, description: 'Bewaffneter Schutz für Handelskonvois.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Markt-Effizienz` },
        { id: 'market_banken', title: 'Interstellare Banken', imagePath: 'assets/img/trade/interstellare-banken.png', requiredLevel: 20, baseCost: { credits: 40000, gold: 8000 }, costMultiplier: 1.5, description: 'Banken ermöglichen galaktische Kredite und Investitionen.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Markt-Effizienz` },
      ],
    },
    {
      ...
      upgrades: [
        ...
        { id: 'exchange_monopol', title: 'Monopol-Lizenzen', imagePath: 'assets/img/trade/monopol-lizenzen.png', requiredLevel: 15, baseCost: { credits: 80000, xenonit: 3000 }, costMultiplier: 1.5, description: 'Exklusive Handelsrechte für bestimmte Sektoren.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Börsen-Effizienz` },
        { id: 'exchange_waehrungsamt', title: 'Galaktisches Währungsamt', imagePath: 'assets/img/trade/galaktisches-waehrungsamt.png', requiredLevel: 20, baseCost: { credits: 250000, xenonit: 10000 }, costMultiplier: 1.6, description: 'Kontrolliere die galaktische Währung.', effectFn: (lvl) => `+${Math.max(1, lvl) * 5}% Börsen-Effizienz` },
      ],
    },
  ];
